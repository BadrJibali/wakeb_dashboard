const gulp = require('gulp'),
    ...
    jsSRC = [
        ...
        './node_modules/chart.js/dist/chart.min.js',                         //////chart js library.
        './src/assets/js/data_circle_chart.js',
...
gulp.task('html', () => {
    return gulp.src([ src_folder + 'pages/' + '**/*.html' ], {
        ...
        .pipe(data(function() {
            return require('./src/template/data.json')  /////To Use data.json File
        }))
        .pipe(nunjucksRender({
...
gulp.task('watch', () => {
    ...
    gulp.watch(src_folder + '**/*.html', gulp.series('html')).on('change', browserSync.reload);
